...
load("simu_LFK_Schwarzer2002.rda")
#
...
#
# Critical values based on type I error of LFK index test for
# - k = 10, 20 (Egger test)
# - k = 10, 20, 50 (Begg-Mazumdar test and Thompson-Sharp)
#
sel <- d1$N_studies <= 20
#
